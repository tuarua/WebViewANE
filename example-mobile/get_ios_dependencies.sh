...
wget https://github.com/tuarua/WebViewANE/releases/download/1.7.0/ios_dependencies.zip
unzip -u -o ios_dependencies.zip
rm ios_dependencies.zip

wget -O ../native_extension/ane/WebViewANE.ane https://github.com/tuarua/WebViewANE/releases/download/1.7.0/WebViewANE.ane?raw=true
